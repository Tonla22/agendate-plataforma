...
const styles = fs.readFileSync(path.join(root, 'frontend', 'styles', 'admin-system.css'), 'utf8');
...
assert.match(frontend, /href="\/styles\/admin-system\.css"/);
assert.match(styles, /\.sistema-grid/);
